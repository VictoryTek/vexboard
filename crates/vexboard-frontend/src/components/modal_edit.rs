    ...
    view! {
        <Show when=move || visible.get()>
            ...
            <div style="position:fixed; inset:0; z-index:50; display:flex; align-items:center; justify-content:center;">
                ...
                ></div>
                // Panel
                <div style="position:relative; background:var(--color-bg-surface); border:1px solid var(--color-border); border-radius:1rem; box-shadow:0 25px 50px rgba(0,0,0,0.5); width:100%; max-width:420px; padding:1.5rem; margin:1rem;">
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.875rem;">
                        ...
                        <div>
                            ...
                            <input type="url" class="form-input"
                                ...
                                on:input=move |ev| {
                                    ...
                                    // Auto-populate icon if it is empty or was previously auto-set
                        ...
                        <div>
                            ...
                            <div style="display:flex; align-items:center; gap:0.5rem;">
                                // Live preview box
                                <div style="width:2.25rem;height:2.25rem;flex-shrink:0;border-radius:0.5rem;background:var(--color-bg-primary);border:1px solid var(--color-border);display:flex;align-items:center;justify-content:center;overflow:hidden;">
                                    {move || {
                                        let ic = icon.get();
