...
#[openapi(
    ...
    paths(
        ...
        crate::api::quick_link_groups::list_quick_link_groups,
        crate::api::quick_link_groups::create_quick_link_group,
        crate::api::quick_link_groups::update_quick_link_group,
        crate::api::quick_link_groups::delete_quick_link_group,
    ...
    components(
        schemas(
            ...
            crate::db::models::QuickLinkGroup,
            crate::db::models::CreateQuickLinkGroup,
            crate::db::models::UpdateQuickLinkGroup,
    ...
    tags(
        ...
        (name = "quick-link-groups", description = "Quick link group management"),
